...
import type { Magosradares } from "@/features/config-devices/types/ConfigServices.type";
...
const MagosradarRingLabels = memo(function MagosradarRingLabels({
  ringLabels,
  colorPulse,
}: {
...
const MagosradarDeviceMarker = memo(function MagosradarDeviceMarker({
  lon,
  lat,
  colorPrimary,
  nombre,
          ...
          >
            ...
            <g
              style={{
                ...
                animation: "radar-spin-mg 3s linear infinite",
              }}
            >
              <path d="M12 12 L12 3" />
...
export interface MagosradarDeviceLayerProps {
  mg: Magosradares;
  colorPrimary: string;
  colorPulse: string;
}

export const MagosradarDeviceLayer = memo(function MagosradarDeviceLayer({
  mg,
  colorPrimary,
  colorPulse,
}: MagosradarDeviceLayerProps) {
  ...
  const radio = mg.radio;
  const apertura = mg.apertura;
  const grado = mg.grado;
  ...
  return (
    <>
      ...
      <MagosradarRingLabels ringLabels={ringLabels} colorPulse={colorPulse} />
      <MagosradarDeviceMarker
        lon={lon}
        lat={lat}
...
export interface MagosradarPulseLayerProps {
  sid: string;
  lat: number;
  lon: number;
  radio: number;
...
export const MagosradarPulseLayer = memo(function MagosradarPulseLayer({
  sid,
  lat,
  lon,
  radio,
