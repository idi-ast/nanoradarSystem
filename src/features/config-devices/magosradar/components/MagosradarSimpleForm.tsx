...
export function MagosradarSimpleForm({
  ...
  return (
    <form onSubmit={handleSubmit} className="flex flex-col gap-3 max-h-[70vh] overflow-y-auto pr-1">
      ...
      <FieldRow>
        <Field label="Color de tracks" name="trackColor" value={form.trackColor ?? ""} onChange={handleChange} placeholder="#00e5ff"
          info="Color único para los tracks de este radar. Vacío = paleta automática." />
        <Field label="Notas" name="notas" value={form.notas ?? ""} onChange={handleChange} placeholder="Radar principal" />
      </FieldRow>
